...
// physical Wi-Fi/cellular swap. Self-debounces with DEBOUNCE_MS to coalesce
// noisy callbacks during transitions (Android often fires onAvailable/
// onCapabilitiesChanged 3-5 times in quick succession while a network
// settles), and the primed flag skips the first onAvailable after
// registration so app cold-start does not burn a handshake.
