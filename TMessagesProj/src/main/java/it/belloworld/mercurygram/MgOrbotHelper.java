...
public final class MgOrbotHelper {
    ...
    private static final String FDROID_ORBOT_URL = "https://f-droid.org/packages/org.torproject.android/";
    ...
    public static Intent getInstallIntent() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(FDROID_ORBOT_URL));
