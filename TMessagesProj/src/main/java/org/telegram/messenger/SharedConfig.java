...
public class SharedConfig {
    ...
    public static byte[] webPushPrivateKey;    // PKCS#8-encoded P-256 private key
    public static byte[] webPushPublicKey;     // Raw 65-byte uncompressed P-256 point (04||X||Y)
    public static byte[] webPushAuthSecret;    // 16-byte random auth secret
